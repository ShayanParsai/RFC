...
public class SNTPMessage {
    ...
    public String toString(){
        return "LI: " + leapIndicator + "\n" +
                "Version: " + versionNumber + "\n" +
                "Mode: " + modeToConstant(mode) + "\n" +
                "Stratum: " + stratum + "\n" +
                "Poll: " + pollInterval + "\n" +
                "Precision: " + precision + "\n" +
                "Root Delay: " + rootDelay + "\n" +
                "Root Dispersion: " + rootDispersion + "\n" +
                "Reference Identifier: " + byteArrayToString(referenceIdentifier) + "\n" +
    ...
    private Mode modeToConstant(int i) {
        return Mode.values()[i];
    }

    private enum Mode {
        reserved, symmetricActive, symmetricPassive, client, server,
        broadcast, reservedForNTPControlMessage, reservedForPrivateUse,
    }
